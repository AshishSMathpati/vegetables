...
function CartVegetableCard({
  ...
  return (
    <div className="border border-solid border-slate-500 bg-white m-5 p-4 rounded flex items-center">
      <div>
        <img
          src={image}
          alt={name}
      ...
      <div className="w-full">
        ...
        <div className="flex justify-end w-full">
          <Button title={"Remove From Cart"} size="small" variant="danger" onClick={() => removeFromCart(id)} />
        </div>
